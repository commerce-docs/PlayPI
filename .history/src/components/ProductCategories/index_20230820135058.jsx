...
const ProductCategories = () => {
  const {
    dataStore: { categories, selectedCategory },
    isLoading,
...
function DropdownCategories({ categories, selectedCategory, updateSelectedCategoryLevel }) {
  return (
...
function BlockCategories({ categories, selectedCategory, updateSelectedCategoryLevel }) {
  return (
