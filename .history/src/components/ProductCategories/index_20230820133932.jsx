...
const ProductCategories = (categories, selectedCategory, updateSelectedCategory) => {
  console.log('🚀 ~ file: index.jsx:6 ~ ProductCategories ~ categories:', categories);

  return (
    <div className='mt-6 -mb-6 px-4'>
      <DropdownCategories
        categories={categories}
        selectedcategoryLevel={selectedCategory}
        updateSelectedCategoryLevel={updateSelectedCategory}
      />
      <BlockCategories
        categories={categories}
        selectedcategoryLevel={selectedCategory}
